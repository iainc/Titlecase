...
- (void)testTitlecase {
    // Test cases are from John Gruber, David Gouch, and Aristotle Pagaltzis. https://github.com/ap/titlecase/blob/master/test.pl
    NSDictionary<NSString *, NSString *> *titlecaseStrings = @{
    ...
    [titlecaseStrings enumerateKeysAndObjectsUsingBlock:^(NSString *text, NSString *expectedTitlecaseString, BOOL *stop) {
        XCTAssertEqualObjects(text.titlecaseString, expectedTitlecaseString);
    }];
}
